<?php
Class ManuelCommentairesModel extends Model{
  ...
  PRIMARY KEY  (`id`)
	...
	*/
	...
	$sql = array (
		...
		'conditions' => array('valide' => $valide, 'id_manuel' => $id),
		'order' => 'id '.$ordre,
		'limit' => $start.', '.$stop
		);
