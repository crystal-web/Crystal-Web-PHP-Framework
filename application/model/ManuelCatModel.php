<?php
class ManuelCatModel extends Model{
...
$categorieReq = array(
		'fields'		=> 'ManuelCat.categorie,  ManuelCat.idcategorie, COUNT( Manuel.id ) AS nb',
		'conditions'	=> array('Manuel.online' => $online, 'Manuel.type' => $this->type),
		//'limit'		=> ($perPage*($this->request->page-1)).','.$perPage,
		'join'			=> array(__SQL . '_Manuel as Manuel' => 'ManuelCat.idcategorie = Manuel.categorieid AND Manuel.online = \'y\''),
		'group'			=> 'idcategorie',
