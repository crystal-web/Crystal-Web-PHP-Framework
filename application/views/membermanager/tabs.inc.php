...
<form method="post" action="<?php echo Router::url('membermanager/search'); ?>">
...
<ul class="tabs">
	<li<?php echo ($request->getAction() == 'index' OR $request->getAction() == 'search' OR $request->getAction() == 'edituser' ) ? ' class="active"' : ''; ?>><a href="<?php echo Router::url('membermanager'); ?>">Gestion des membres</a></li>
	<li<?php echo ($request->getAction() == 'config') ? ' class="active"' : ''; ?>><a href="<?php echo Router::url('membermanager/config'); ?>">Configuration</a></li>
	<li<?php echo ($request->getAction() == 'adduser') ? ' class="active"' : ''; ?>><a href="<?php echo Router::url('membermanager/adduser'); ?>">Ajouter un membre</a></li>
	<li<?php echo ($request->getAction() == 'multiaccounts') ? ' class="active"' : ''; ?>><a href="<?php echo Router::url('membermanager/multiaccounts'); ?>">Multicomptes</a></li>
</ul>
