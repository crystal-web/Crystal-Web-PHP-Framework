...
class Form{
    ...
    public function password($name, $label, $options = array()) {
        ...
        $html .= '<input type="password" id="input'.$name.'" name="'.$name.'"'.$attr.'>';
    ...
    private function xCodeEditor($options, $name, $value) {
        ...
        ?>
            <div class="xCode">
                ...
                <textarea class="xCodeContent" placeholder="Corps du message" cols="30" rows="10" tabindex="30" id="inputcontent" name="<?php echo $name; ?>"></textarea>
