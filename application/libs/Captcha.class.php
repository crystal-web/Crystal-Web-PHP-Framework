...
class Captcha {
	...
	* @return IMG Tag */
	...
	return "<a href=\"#\"><img alt=\"".i18n::get('Click the picture to change the color')."\" title=\"Clique pour changez les couleurs\"". " src=\"" . __CW_PATH . "/media.php?pck=".$_SESSION['captcha_akey']."\"". " id=\"captcha\"". " onclick=\"javascript:this.src='" . __CW_PATH . "/media.php?pck=". $_SESSION['captcha_akey']. "&z='+Math.random();return false;\" /></a>\n";
	}
