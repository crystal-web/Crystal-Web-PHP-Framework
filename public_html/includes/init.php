...
define ('__CW_PATH', 'http://localhost/CMS-for-Developer-PHP/public_html'); // Site url/~devphp sans / final
...
define ('DB_name', 'general'); // le nom de votre base de donn�es
...
/***  ***/
define ('ADMIN_TEAM', 'Beta site'); // Adresse exp�diteur
